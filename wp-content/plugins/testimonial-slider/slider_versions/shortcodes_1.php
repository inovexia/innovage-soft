...
function testimonial_slider_simple_shortcode($atts) {
	...
	return return_testimonial_slider($id,$set,(int) $offset);
}
...
function testimonial_slider_category_shortcode($atts) {
	...
	return return_testimonial_slider_category($catg_slug,$set,(int) $offset);
}
...
function testimonial_slider_recent_shortcode($atts) {
	...
	return return_testimonial_slider_recent($set,(int)$offset);
}
